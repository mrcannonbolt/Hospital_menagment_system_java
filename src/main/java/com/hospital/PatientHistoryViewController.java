...
public class PatientHistoryViewController {
    ...
    public void saveDetails() {
        ...
        if (selectedPatient != null) {
            if(patientName!=null||patientGender!=null||patientDate!=null||patientPesel!=null||patientStatus!=null){
                try{
                    ...
                    if(selectedPatient.getPatientStatus() == PatientStatus.DISCHARGED || selectedPatient.getPatientStatus() == PatientStatus.HOSPITAL_CLIENT){
                        if(selectedPatient.getAssignedBed()!=null){
                            selectedPatient.getAssignedBed().releaseBed();
                            selectedPatient.setAssignedBed(null);
                            showAlert("Informacja","Pacjent wypisany ze szpitala",Alert.AlertType.INFORMATION);
                        }
                    }
            ...
            else showAlert("Błąd", "Wszystkie pola muszą być wypełnione.", Alert.AlertType.ERROR);
        }
    }
